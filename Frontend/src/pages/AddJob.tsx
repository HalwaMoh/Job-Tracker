...
function AddJob() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitMessage("Application saved. Redirecting to your dashboard...");
          ...
          <div className="mb-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-base text-gray-600">
                Capture each application clearly so your job search stays organized and motivating.
              </p>
            </div>
          ...
          {submitMessage ? (
            <div
              className={`mb-6 rounded-2xl border px-4 py-3 text-sm ${
                submitMessage.includes("saved") || submitMessage.includes("Redirecting")
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col gap-3 border-t border-[#edf2ea] pt-6 sm:flex-row sm:items-center sm:justify-between">
              <p className="text-sm text-gray-500">
                Your application will be saved instantly and appear on your dashboard.
              </p>
